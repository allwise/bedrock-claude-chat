const translation = {
    translation: {
        ...
        agent: {
            ...
            hint: `Agenten bestemmer automatisk hvilke verktøy som skal brukes for å svare på brukerens spørsmål. På grunn av tiden som kreves for beslutning, har responstiden en tendens til å være lengre. Aktivering av ett eller flere verktøy aktiverer agentens funksjonalitet. Omvendt, hvis ingen verktøy er valgt, blir ikke agentens funksjonalitet utnyttet. Når agentens funksjonalitet er aktivert, behandles bruken av "Kunnskap" også som ett av verktøyene. Dette betyr at "Kunnskap" kanskje ikke blir brukt i svarene.`,
            progress: {
                label: 'Tenker...',
            },
            progressCard: {
        ...
        bot: {
            label: {
                myBots: 'Mine roboter',
                recentlyUsedBots: 'Nylig brukte delte roboter',
                knowledge: 'Kunnskap',
                url: 'URL',
                s3url: 'S3-datakilde',
                sitemap: 'Sitemap URL',
                ...
                notAvailableBotInputMessage: 'Denne roboten er IKKE tilgjengelig.',
                noDescription: 'Ingen beskrivelse',
                notAvailable: 'Denne roboten er IKKE tilgjengelig.',
                noBots: 'Ingen roboter.',
                noBotsRecentlyUsed: 'Ingen nylig brukte delte roboter.',
            ...
            help: {
                overview:
                    'Roboter opererer i henhold til forhåndsdefinerte instruksjoner. Chat fungerer ikke som ønsket med mindre konteksten er definert i meldingen, men med roboter er det ikke nødvendig å definere konteksten.',
                instructions:
                    'Definer hvordan roboten skal oppføre seg. Å gi tvetydige instruksjoner kan føre til uforutsigbar oppførsel, så gi klare og spesifikke instruksjoner.',
                knowledge: {
                    overview:
                        'Ved å gi ekstern kunnskap til roboten, blir den i stand til å håndtere data den ikke er forhåndstrent på.',
                ...
                quickStarter: {
                    overview:
                        'Når du starter en samtale, gi eksempler. Eksempler illustrerer hvordan man bruker roboten.',
                },
            },
            alert: {
                sync: {
                    ...
                    incomplete: {
                        title: 'IKKE klar',
                        body: 'Denne roboten har ikke fullført kunnskapssynkroniseringen, så kunnskapen før oppdateringen brukes.',
                    },
                },
            },
            samples: {
...
Hvordan vil du kategorisere denne e-posten?`,
            ...
            create: {
                pageTitle: 'Opprett min robot',
            },
            edit: {
                pageTitle: 'Rediger min robot',
            },
            ...
            explore: {
                label: {
                    pageTitle: 'Robotkonsoll',
                },
            },
            apiSettings: {
                pageTitle: 'Innstillinger for publisering av delt robot-API',
                label: {
                ...
                help: {
                    overview:
                        "Å opprette et API gjør at robotens funksjoner kan nås av eksterne klienter; API-er muliggjør integrasjon med eksterne applikasjoner.",
                    endpoint: 'Klienten kan bruke roboten fra dette endepunktet.',
                    usagePlan:
                ...
                alert: {
                    botUnshared: {
                        title: 'Vennligst del roboten',
                        body: 'Du kan ikke publisere et API for en robot som ikke er delt.',
                    },
                    deploying: {
            ...
            shareDialog: {
                ...
                off: {
                    content:
                        'Lenkedelingsfunksjonen er av, så kun du kan få tilgang til denne roboten gjennom URL-en.',
                },
                on: {
                    content:
        ...
        admin: {
            sharedBotAnalytics: {
                label: {
                    pageTitle: 'Analyser for delt robot',
                    noPublicBotUsages:
                        'I løpet av beregningsperioden ble ingen offentlige roboter brukt.',
                ...
                help: {
                    overview:
                        'Overvåk bruksstatusen for delte roboter og publiserte robot-API-er.',
                    calculationPeriod:
            ...
            botManagement: {
                label: {
                    pageTitle: 'Robotadministrasjon',
                    sharedUrl: 'Delt robot-URL',
                    apiSettings: 'API-publiseringsinnstillinger',
                    noKnowledge: 'Denne roboten har ingen kunnskap.',
                    notPublishApi: 'Denne robotens API er ikke publisert.',
        ...
        button: {
            newChat: 'Ny chat',
            botConsole: 'Robotkonsoll',
            sharedBotAnalytics: 'Analyser for delt robot',
        ...
        knowledgeBaseSettings: {
            ...
            description:
                'Velg den innebygde modellen for å konfigurere kunnskap, og sett metoden for å dele opp dokumenter som legges til som kunnskap. Disse innstillingene kan ikke endres etter at roboten er opprettet.',
            embeddingModel: {
